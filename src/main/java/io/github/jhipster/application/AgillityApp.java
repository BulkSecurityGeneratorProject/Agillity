...
public class AgillityApp {

    private static final Logger log = LoggerFactory.getLogger(AgillityApp.class);

    private final Environment env;

    public AgillityApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Agillity.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AgillityApp.class);
